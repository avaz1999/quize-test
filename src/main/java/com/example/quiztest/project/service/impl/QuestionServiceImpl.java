...
public class QuestionServiceImpl implements QuestionService {
    ...
    @Override
    @Transactional
    public ApiResponse<?> create(QuestionResponse request, Long categoryId) {
    ...
    public ApiResponse<?> getOne(Long id) {
        ...
        QuestionResponse request = QuestionResponse.toDto(question, answers);
    ...
    public ApiResponse<?> getAll(Pageable pageable, String categoryName) {
        ...
        if (questionList == null || questionList.isEmpty()) {
            ...
            List<QuestionResponse> questionRequests = questionList.stream()
                    .map(question -> {
                        List<Answer> answers = answerRepository.findAllByQuestionIdAndDeletedFalse(question.getId());
                        return QuestionResponse.toDto(question, answers);
                    })
                    .toList();
    ...
    @Override
    public ApiResponse<?> edit(Long id, QuestionResponse request) {
